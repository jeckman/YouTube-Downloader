<?php
	...
	function decipherSignature($videoID, $signature){
		ob_start(); //For debugging
		echo("==== Load player script and execute patterns ====\n\n");
		$playerID = loadURL("https://www.youtube.com/watch?v=$videoID");
		...
		if(!file_exists("playerscript/$playerID")) {
			$decipherScript = loadURL("https://youtube.com/yts/jsbin/player-$playerURL");
		...
		$decipheredSignature = executeSignaturePattern($decipherPatterns, $deciphers, $signature);
