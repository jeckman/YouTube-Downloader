...
Bugs are tracked as [GitHub issues](https://guides.github.com/features/issues/). When creating an issue please provide the following information by filling in [the template](ISSUE_TEMPLATE.md).
